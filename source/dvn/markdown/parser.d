...
import dvn.markdown.type;
import dvn.markdown.part;
...
*/
public string parseToHtml(string markdown, string delegate(MarkdownPart) customParser = null)
{
  string result;
...
*/
public MarkdownPart[] parse(string markdown)
{
