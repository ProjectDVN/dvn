...
public abstract class Component
{
  ...
  package(zid) void updateRect(bool updateParent)
  {
  ...
  final
  {
    ...
    // package(zid) void setBoundsSize(IntVector size)
    // {
    //   //_boundsRectangle = Rectangle(_rect.x, _rect.y, size.x, size.y);
    // }
    package(zid) IntVector getScrollPosition()
    {
      return _scrollPosition;
    }

    package(zid) void setScrollPosition(IntVector scrollPosition)
    {
  ...
  @property
  {
    final
    {
      ...
      package(zid) bool allowChildren() { return _allowChildren; }
      ...
      package(zid) void view(View newView)
      {
        _view = newView;
      }
