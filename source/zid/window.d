...
import zid.events;
import zid.application;
import zid.view;
import zid.sheetcollection;
import zid.colors;
...
public final class Window
{
  ...
  public:
  final:
  package(zid) this(Application application, string title, IntVector size, bool isFullScreen, Color backgroundColor)
  {
  ...
  package(zid) void executePreRender()
  {
